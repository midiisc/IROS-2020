...
\begin{center}
   \centering
    \includegraphics[width=\textwidth]{Figures/Teaser.pdf}
     \vspace{-2em}
    \captionof{figure}{We present a test-bed setup for evaluating vision-based navigation for lunar operations. (A) Virtual lunar topography within the simulation testbed with synthetic terrain and accurate photometric responses modeled after the surface of the moon. (B) Top-down view of the entire 1 km $\times$ 1 km lunar terrain. (C) The MER 1 rover dynamic model used in our case study simulation.}
    \label{teaserfig}
\end{center}
}]
