...
\newcommand\coltxt[1]{{ \ifthenelse{\isempty{#1}}%
    {\textbf{\textcolor{blue}{(Ref.)}}}
    {\textbf{\textcolor{blue}{(#1)}}}}}

\newcommand\msm[1]{\ifthenelse {\boolean{showNotes}}
 { \ifthenelse{\isempty{#1}}%
    {\textbf{\textcolor{blue}{(Ref.)}}}% if #1 is empty
    {\textbf{\textcolor{blue}{(#1)}}}}% if #1 is not empty
 {}
}
\newcommand\dk[1]{\ifthenelse {\boolean{showNotes}}
 { \ifthenelse{\isempty{#1}}%
    {\textbf{\textcolor{green}{(Ref.)}}}% if #1 is empty
    {\textbf{\textcolor{green}{(#1)}}}}% if #1 is not empty
 {}
}
\newcommand\dz[1]{\ifthenelse {\boolean{showNotes}}
 { \ifthenelse{\isempty{#1}}%
    {\textbf{\textcolor{red}{(Ref.)}}}% if #1 is empty
    {\textbf{\textcolor{red}{(#1)}}}}% if #1 is not empty
 {}
}
